...
void MyCAN_Init(void)
{
	...
	CAN_FilterInitSturcture.CAN_FilterIdHigh = 0x200 << 5;
	CAN_FilterInitSturcture.CAN_FilterMaskIdHigh = (0x700<<5) |0x10|0x8;
	
	CAN_FilterInitSturcture.CAN_FilterIdLow = 0x320 << 5;
	CAN_FilterInitSturcture.CAN_FilterMaskIdLow = (0x7F0<<5) |0x10|0x8;
